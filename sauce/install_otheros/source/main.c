...
//#define BDEMU_DEV_ID 	              0x101000000000008ull
//#define USB000_DEV_ID               0x10300000000000aull
...
#define MIN(a, b)	((a) <= (b) ? (a) : (b))
	...
	start_sector = 0;
	sector_count = VFLASH5_HEADER_SECTORS + VFLASH5_OS_DB_AREA_SECTORS;						//2 * 2
