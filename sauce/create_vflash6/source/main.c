...
#define VFLASH_REGION_START_SECTOR							0x7fa00ull
...
int main(int argc, char **argv){
	...
	result = lv2_storage_create_region(dev_handle, VFLASH_REGION_START_SECTOR, VFLASH_REGION_SECTOR_COUNT, 0, VFLASH_REGION_LAID, &region_id);
	if (result) {
